<form method="post" action="">
	...
	<div class="form-group row">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control" name="student[last_name]" placeholder="Last Name" value="" required>
			<div class="text-danger"><?php echo form_error('last_name'); ?></div>
		</div>
		<div class="col-sm-3">
			<input type="text" class="form-control" name="student[first_name]" placeholder="First Name" value="" required>
			<div class="text-danger"><?php echo form_error('first_name'); ?></div>
		</div>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="student[middle_name]" placeholder="Middle Name" value="">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="student[current_address]" placeholder="Current Address" value="" required>
	...
	<div class="form-group row">
		...
		<div class="col-sm-5">
			<input type="text" class="form-control" name="student[telephone_number]" placeholder="Telephone #" value="">
			<div class="text-danger"><?php echo form_error('telephone_number'); ?></div>
		</div>
		<div class="col-sm-5">
			<input type="text" class="form-control" name="student[mobile_number]" placeholder="Mobile #" value="">
	...
	<div class="form-group row">
			...
			<div class="col-sm-10">
					<input type="email" class="form-control" name="student[email_address]" placeholder="example@email.com" value="">
			</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-2 col-form-label">Birth Information</label>
		<div class="col-sm-5">
			<input type="text" name="student[birth_date]" class="form-control birthdatepicker" placeholder="Birth Date" value="">
		</div>
		<div class="col-sm-5">
			<input type="text" name="student[birth_place]" class="form-control" placeholder="Birth Place" value=">">
		</div>
	</div>
