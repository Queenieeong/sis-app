<form method="post" action="<?php echo site_url('student/update/' . $studentID); ?>">
	<h4>Student Information</h4><br>
	<div class="form-group row">
		<label class="col-sm-2 col-form-label">Student Name</label>
		<div class="col-sm-3">
			<input type="text" class="form-control" name="student[last_name]" placeholder="Last Name" value="<?php echo $studentDetails['last_name']; ?>" required>
			<div class="text-danger"><?php echo form_error('last_name'); ?></div>
		</div>
		<div class="col-sm-3">
			<input type="text" class="form-control" name="student[first_name]" placeholder="First Name" value="<?php echo $studentDetails['first_name']; ?>" required>
			<div class="text-danger"><?php echo form_error('first_name'); ?></div>
		</div>
		<div class="col-sm-2">
			<input type="text" class="form-control" name="student[middle_name]" placeholder="Middle Name" value="<?php echo $studentDetails['middle_name']; ?>">
	...
	<div class="form-group row">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="student[current_address]" placeholder="Current Address" value="<?php echo $studentDetails['current_address']; ?>" required>
	...
	<div class="form-group row">
		...
		<div class="col-sm-5">
			<input type="text" class="form-control" name="student[telephone_number]" placeholder="Telephone #" value="<?php echo $studentDetails['telephone_number']; ?>">
			<div class="text-danger"><?php echo form_error('telephone_number'); ?></div>
		</div>
		<div class="col-sm-5">
			<input type="text" class="form-control" name="student[mobile_number]" placeholder="Mobile #" value="<?php echo $studentDetails['mobile_number']; ?>">
	...
	<div class="form-group row">
			...
			<div class="col-sm-10">
					<input type="email" class="form-control" name="student[email_address]" placeholder="example@email.com" value="<?php echo $studentDetails['email_address']; ?>">
			</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-2 col-form-label">Birth Information</label>
		<div class="col-sm-5">
			<input type="text" name="student[birth_date]" class="form-control birthdatepicker" placeholder="Birth Date" value="<?php echo $studentDetails['birth_date']; ?>">
		</div>
		<div class="col-sm-5">
			<input type="text" name="student[birth_place]" class="form-control" placeholder="Birth Place" value="<?php echo $studentDetails['birth_place']; ?>">
		</div>
	</div>
	...
	<fieldset class="form-group">
		<div class="row">
			<div class="col-sm-10">
				<div class="form-check form-check-inline">
					<input name="student[parent_type_id]" class="form-check-input" type="radio" value="1">
					<label class="form-check-label">Father</label>
				</div>
				<div class="form-check form-check-inline">
					<input name="student[parent_type_id]" class="form-check-input" type="radio" value="0">
