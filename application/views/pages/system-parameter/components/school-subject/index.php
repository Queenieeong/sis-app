<div class="row">
    <div class="col-sm-3">
        <button type="button" class="btn btn-raised btn-primary" data-toggle="modal" data-target="#createNewSubject">Create New Subject</button>
        <div class="modal fade" id="createNewSubject" tabindex="-1" role="dialog">
